<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold">แก้ไข Invoice {{ $invoice->invoice_number }}</h2>
    </x-slot>
        ...
        <form method="POST" action="{{ route('invoices.update', $invoice) }}"
                ...
                <table class="w-full text-sm" id="items-table">
                    ...
                    <tbody id="items-body">
                        ...
                        <tr class="item-row border-t">
                            ...
                            <td class="p-2 text-right amount">
            ...
            <div>
                ...
                <textarea name="notes" rows="3"
                          class="w-full border rounded px-3 py-2">{{ old('notes', $invoice->notes) }}</textarea>
            </div>
